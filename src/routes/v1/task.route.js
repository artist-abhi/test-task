 ...
 *     description: Only admins can create other task.
 *     tags: [Tasks]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *   get:
 *     summary: Get a task
 *     description: Fetch task specific to id, only for logged in users.
 *     tags: [Tasks]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can only update.
 *     tags: [Tasks]
 *     security:
 *       - bearerAuth: []
 *     parameters:
